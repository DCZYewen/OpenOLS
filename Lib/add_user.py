...
sql1 = "\
    INSERT INTO USERS VALUES(\
        99999999 , 'Administrator' , 2099 , 99 , 99999999 , "  + "'" + generate_password_hash('admin') + "'" + ''' , 'ADMIN' , 'admin' , 000000 , '20020202020202' , '男' , '无' , '无' 
    )
'''
...
sql = "\
    INSERT INTO USERS VALUES(\
        99999998 , 'Test_Stu1' , 2099 , 99 , 99999998 , "  + "'" + generate_password_hash('student1') + "'" + ''' , 'STUDENT' , 'student1' , 000000 , '20020202020202' , '男' , '无' , '无' 
    )
'''
...
sql2 = "\
    INSERT INTO USERS VALUES(\
        99999997 , 'TEACHER1' , 2099 , 99 , 99999997 , "  + "'" + generate_password_hash('teacher1') + "'" + ''' ,'TEACHER' , 'teacher1' , 000000 , '20020202020202' , '男' , '无' , '无' 
    )
'''
